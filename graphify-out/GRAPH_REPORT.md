...
## Corpus Check
- 20 files · ~56,123 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 480 nodes · 1150 edges · 11 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `49f67dd9`
...
Cohesion: 0.07
Nodes (68): buildDriverNameLookup(), CONSTRUCTOR_SUFFIXES, FIA_NAT_TO_FLAG, FiaDriverRow, findFp1SectionStart(), FP1_SECTION_MARKERS, getFlagFromNatCode(), isDriverListedInFiaPdf() (+60 more)

### Community 1 - "f1-api.ts"
Cohesion: 0.06
Nodes (56): buildConstructorLookup(), buildFiaEntryListUrl(), buildPracticeSessionUrl(), circuitsMatch(), cleanOfficialName(), Constructor, constructorFromSeasonRoster(), ConstructorStanding (+48 more)

### Community 2 - "index.ts"
Cohesion: 0.06
Nodes (79): isCareerStandingsBehind(), isCareerStandingsOwnerRound(), shouldSyncCareerStandingsForRound(), getDriverStandings(), getLatestConcludedRound(), setActiveSeasonSchedule(), computeNextLatestDataValues(), findInfoboxParamLineIndex() (+71 more)
...
Cohesion: 0.13
Nodes (35): buildFetchInit(), cachedJolpicaJson(), CachedScheduleRace, CacheTtl, classifyJolpicaUrl(), createF1ApiContext(), createF1ApiContextFromEnv(), F1ApiContext (+27 more)
...
### Community 7 - "fetch"
Cohesion: 0.09
Nodes (39): getLapChart(), getQualifyingResult(), getRaceResult(), getSchedule(), getScheduleWithRetry(), mapRaceResults(), normalizeScheduleRaces(), RaceResult (+31 more)

### Community 8 - "kv-ops.ts"
Cohesion: 0.08
Nodes (41): checkAndSendDailySummary(), findBestHeader(), syncCareerResultsTestDrivers(), apiLogBuffer, ApiLogEntry, beginKvInvocation(), bufferApiLog(), clearEditFailures() (+33 more)
...
- **Why does `scheduled()` connect `index.ts` to `wikitext-generator.ts`, `f1-api.ts`, `f1-api-cache.ts`, `fetch`, `kv-ops.ts`, `llm-reporter.ts`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `trackedKvPut()` connect `fetch` to `kv-ops.ts`, `f1-api.ts`, `index.ts`, `f1-api-cache.ts`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `cachedJolpicaJson()` connect `f1-api-cache.ts` to `f1-api.ts`, `index.ts`, `fetch`?**
