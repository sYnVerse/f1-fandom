...
1. `scheduled()` - 78 edges
2. `fetch()` - 43 edges
3. `compilerOptions` - 21 edges
4. `cachedJolpicaJson()` - 17 edges
...
Cohesion: 0.06
Nodes (70): Driver, buildDriverNameLookup(), CONSTRUCTOR_SUFFIXES, FIA_NAT_TO_FLAG, FiaDriverRow, findFp1SectionStart(), FP1_SECTION_MARKERS, getFlagFromNatCode() (+62 more)

### Community 1 - "Wiki Standings Syncing and Formatting"
Cohesion: 0.07
Nodes (78): buildPracticeSessionUrl(), createF1ApiContext(), createF1ApiContextFromEnv(), cleanOfficialName(), fetchOfficialRaceName(), fetchRoundJolpicaData(), getConstructorStandings(), getDriverStandings() (+70 more)
...
Cohesion: 0.08
Nodes (42): buildConstructorLookup(), buildFiaEntryListUrl(), CachedScheduleRace, circuitsMatch(), Constructor, ConstructorStanding, convertOpenF1PracticeResults(), DriverStanding (+34 more)
...
Cohesion: 0.12
Nodes (31): apiLogBuffer, ApiLogEntry, beginKvInvocation(), bufferApiLog(), clearEditFailures(), editFailureKey(), getEditFailureCount(), isEditBlocked() (+23 more)
...
Cohesion: 0.15
Nodes (27): buildFetchInit(), cachedJolpicaJson(), CacheTtl, classifyJolpicaUrl(), fetchJolpica(), fetchJolpicaUncached(), getCacheTtl(), getFirstPracticeEndTime() (+19 more)
...
- **Why does `fetch()` connect `Wiki Standings Syncing and Formatting` to `F1 API Clients and Types`, `F1 Statistics and Calculations`, `Daily Reporting and Cloudflare Worker HTTP`, `Community 9`, `Community 10`, `Community 12`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `trackedKvPut()` connect `F1 Statistics and Calculations` to `Wiki Standings Syncing and Formatting`, `Community 12`, `Daily Reporting and Cloudflare Worker HTTP`, `Community 9`?**
