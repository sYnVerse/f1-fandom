...
## Corpus Check
- 19 files · ~55,357 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 474 nodes · 1164 edges · 12 communities
...
Cohesion: 0.07
Nodes (76): buildDriverNameLookup(), getFlagFromNatCode(), getPracticeEndTime(), loadCachedTestDrivers(), mergeTestDriverCaches(), saveCachedTestDrivers(), scheduled(), syncCareerResultsTestDrivers() (+68 more)

### Community 1 - "Wiki Standings Syncing and Formatting"
Cohesion: 0.07
Nodes (61): getLatestConcludedRound(), getSchedule(), getScheduleWithRetry(), normalizeScheduleRaces(), scheduleCacheKey(), setActiveSeasonSchedule(), computeNextLatestDataValues(), findInfoboxParamLineIndex() (+53 more)
...
Cohesion: 0.22
Nodes (13): Driver, CONSTRUCTOR_SUFFIXES, FIA_NAT_TO_FLAG, FiaDriverRow, findFp1SectionStart(), FP1_SECTION_MARKERS, isDriverListedInFiaPdf(), normalizeCarNumber() (+5 more)
...
Cohesion: 0.06
Nodes (67): buildConstructorLookup(), buildFiaEntryListUrl(), buildPracticeSessionUrl(), CachedScheduleRace, createF1ApiContext(), createF1ApiContextFromEnv(), circuitsMatch(), cleanOfficialName() (+59 more)
...
### Community 9 - "wiki.ts"
Cohesion: 0.08
Nodes (43): checkAndSendDailySummary(), findBestHeader(), acquireCronSyncLock(), apiLogBuffer, ApiLogEntry, beginKvInvocation(), bufferApiLog(), clearEditFailures() (+35 more)
...
- **Why does `scheduled()` connect `F1 API Clients and Types` to `Wiki Standings Syncing and Formatting`, `fia-pdf-parser.ts`, `Daily Reporting and Cloudflare Worker HTTP`, `wiki.ts`, `llm-reporter.ts`?**
...
- **Why does `trackedKvPut()` connect `wiki.ts` to `F1 API Clients and Types`, `Wiki Standings Syncing and Formatting`, `F1 Statistics and Calculations`, `Daily Reporting and Cloudflare Worker HTTP`, `f1-api-cache.ts`?**
