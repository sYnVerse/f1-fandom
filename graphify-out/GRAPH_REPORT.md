...
Cohesion: 0.06
Nodes (79): Driver, buildDriverNameLookup(), CONSTRUCTOR_SUFFIXES, FIA_NAT_TO_FLAG, FiaDriverRow, findFp1SectionStart(), FP1_SECTION_MARKERS, getFlagFromNatCode() (+71 more)

### Community 1 - "Wiki Standings Syncing and Formatting"
Cohesion: 0.07
Nodes (68): createF1ApiContext(), createF1ApiContextFromEnv(), getConstructorStandings(), getDriverStandings(), getLatestConcludedRound(), getSchedule(), getScheduleWithRetry(), normalizeScheduleRaces() (+60 more)
...
Cohesion: 0.10
Nodes (32): F1ApiContext, getLapChart(), getQualifyingResult(), getRaceResult(), mapRaceResults(), RaceResult, ScheduleRace, acquireCronSyncLock() (+24 more)
...
Cohesion: 0.06
Nodes (56): buildConstructorLookup(), buildFiaEntryListUrl(), buildPracticeSessionUrl(), CachedScheduleRace, circuitsMatch(), cleanOfficialName(), Constructor, constructorFromSeasonRoster() (+48 more)
...
### Community 9 - "wiki.ts"
Cohesion: 0.14
Nodes (28): findBestHeader(), bufferApiLog(), clearEditFailures(), editFailureKey(), getEditFailureCount(), isEditBlocked(), recordEditFailure(), editPage() (+20 more)

### Community 10 - "llm-reporter.ts"
Cohesion: 0.10
Nodes (31): PracticeSessionData, checkAndSendDailySummary(), corsResponse(), fetch(), verifyTurnstile(), apiLogBuffer, ApiLogEntry, beginKvInvocation() (+23 more)
...
- **Why does `scheduled()` connect `Wiki Standings Syncing and Formatting` to `F1 API Clients and Types`, `F1 Statistics and Calculations`, `Daily Reporting and Cloudflare Worker HTTP`, `wiki.ts`, `llm-reporter.ts`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `fetch()` connect `llm-reporter.ts` to `F1 API Clients and Types`, `Wiki Standings Syncing and Formatting`, `F1 Statistics and Calculations`, `Daily Reporting and Cloudflare Worker HTTP`, `wiki.ts`, `f1-api-cache.ts`?**
